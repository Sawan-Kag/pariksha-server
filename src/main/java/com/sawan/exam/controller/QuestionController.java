...
public class QuestionController {
    ...
    @GetMapping("/quiz/{qid}")
    public ResponseEntity<?> getQuestionsOfQuiz(@PathVariable("qid") String qid) {
//        Quiz quiz = new Quiz();
//        quiz.setqId(qid);
...
//        return ResponseEntity.ok(questionsOfQuiz);
    ...
    public ResponseEntity<?> getQuestionsOfQuizAdmin(@PathVariable("qid") String qid) {
        Quiz quiz = new Quiz();
        quiz.setqId(qid);
        Set<Question> questionsOfQuiz = this.service.getQuestionsOfQuiz(quiz);
        return ResponseEntity.ok(questionsOfQuiz);
...
//        return ResponseEntity.ok(list);
    ...
    //get single question
    @GetMapping("/{quesId}")
    public Optional<Question> get(@PathVariable("quesId") String quesId) {
    ...
    public ResponseEntity<?> evalQuiz(@RequestBody List<Question> questions) {
        ...
        for (Question q : questions) {
            //single questions
            Optional<Question> question = this.service.get(q.getQuesId());
